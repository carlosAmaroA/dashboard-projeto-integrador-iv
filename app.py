...
import pandas as pd
from tabs import overview,temporal,geographic,general,datainfo
...
dbc.Container([
    html.Div([
        dbc.Tabs([
            ...
            dbc.Tab(label='Accident Types & Vehicles',tab_id='type'),
            dbc.Tab(label='Comparisons & Patterns',tab_id='pattern'),
